<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- TAMBAHAN: Menu Khusus Peminjam --}}
                    @if (Auth::user()->role == 'peminjam')
                        <x-nav-link :href="route('peminjam.riwayat')" :active="request()->routeIs('peminjam.riwayat')">
                            {{ __('Riwayat Saya') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- TAMBAHAN: Menu Peminjam (Mobile) --}}
            @if (Auth::user()->role == 'peminjam')
                <x-responsive-nav-link :href="route('peminjam.riwayat')" :active="request()->routeIs('peminjam.riwayat')">
                    {{ __('Riwayat Saya') }}
                </x-responsive-nav-link>
            @endif
        </div>
